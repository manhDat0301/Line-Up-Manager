...
class LandscapeStat extends StatefulWidget {
  final Player player;

  LandscapeStat(this.player);

  @override
  _LandscapeStatState createState() => _LandscapeStatState();
}

class _LandscapeStatState extends State<LandscapeStat> {
  @override
