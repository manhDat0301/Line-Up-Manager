...
import 'my_flutter_keyboard_visibility.dart';
...
class MySearchWidget<T> extends StatefulWidget {
...
class MySingleChoiceSearchState<T> extends State<MySearchWidget<T>> {
  ...
  @override
  void didUpdateWidget(MySearchWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    listContainerWidth =
        widget.listContainerWidth ?? MediaQuery.of(context).size.width * 0.3;
