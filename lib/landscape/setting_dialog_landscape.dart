...
class SettingDialogLandscape extends StatefulWidget {
  @override
  _SettingDialogLandscapeState createState() => _SettingDialogLandscapeState();
}

class _SettingDialogLandscapeState extends State<SettingDialogLandscape> {
