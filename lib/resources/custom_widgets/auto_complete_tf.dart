...
class ScrollableAutoCompleteTextField<T> extends StatefulWidget {
  ...
  final GlobalKey<ScrollableAutoCompleteTextFieldState<T>> key;
  ...
  ScrollableAutoCompleteTextField(
      {@required
...
// 5, //The amount of suggestions to show, larger values may result in them going off screen
  ...
  @override
  State createState() => new ScrollableAutoCompleteTextFieldState(
      suggestions,
      textChanged,
      textSubmitted,
      onFocusChanged,
...
class ScrollableAutoCompleteTextFieldState<T> extends State {
  ...
  ScrollableAutoCompleteTextFieldState(
      this.suggestions,
      this.textChanged,
      this.textSubmitted,
      this.onFocusChanged,
            ...
            child: CompositedTransformFollower(
                ...
                child: ConstrainedBox(
                    constraints: BoxConstraints(
                      ...
                      maxHeight: max(
                        0,
//                        MediaQuery.of(context).viewInsets.bottom + height + 25,
...
class SimpleAutoCompleteTextField extends ScrollableAutoCompleteTextField {
  final StringCallback textChanged, textSubmitted;
  final int minLength;
  ...
  SimpleAutoCompleteTextField(
      ...
      @required GlobalKey<ScrollableAutoCompleteTextFieldState> key,
