...
import 'package:marozi/portrait/position/repository/offset_all.dart';
...
class PositionBloc extends Bloc<PositionEvent, PositionState> {
  ...
  Stream<PositionState> _mapTestEventToState() async* {
    yield PositionSuccess(
      ...
      offsets: OffsetAll.form_4_2_3_1(Constants.width, Constants.height),
      ...
      switch (event.i) {
        case 0:
          yield currentState.copyWith(
            currentPage: event.i,
            offsets: OffsetAll.form_4_2_3_1(width, height),
          );
          break;
        case 1:
          yield currentState.copyWith(
            currentPage: event.i,
            offsets: OffsetAll.form_4_3_3(width, height),
          );
          break;
        case 2:
          yield currentState.copyWith(
            currentPage: event.i,
            offsets: OffsetAll.form_4_4_2(width, height),
          );
          break;
        case 3:
          yield currentState.copyWith(
